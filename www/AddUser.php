...
<html lang="en-us" id="top">
    ...
    <body>
        <article>
             ...
             * Validate the text.
             *
             * @param array $subject the array containing two entries: string
             *                       TEXT, bool VALID.
             *
            ...
            {
                $subject[VALID] = (bool) preg_match(
                    "/^[a-zA-Z]+([ '-]?[a-zA-Z]+)*$/", $subject[TEXT]
                );
            ...
            if (!empty($_POST)) {
                ...
                if ($firstname[VALID] && $lastname[VALID] && !empty($email)) {
                    ...
                    /* You should enable error reporting for mysqli before
                    ...
                    $sql_query = "INSERT INTO `Users` ("
                            ...
                            . ") "
                            . "VALUES (\"{$vars_arr[LNAME]}\", \"{$vars_arr[FNAME]}"
                            . "\", \"{$vars_arr[EMAIL]}\")";
                    ...
                    <td>
                        <form action="AddUser.php" method="post">
                            <table class="hidden">
                                ...
                                <tr>
                                    <td class="right"><label for="fname">
                                            First&nbsp;name:</label></td>
                                    <?php
                                    if (!$result) {
                                        if (empty($firstname[TEXT])) {
                                            echo '<td><input type = TEXT id ='
                                            . ' "fname" name = "fname"><span '
                                        ...
                                        echo '<td><input type = TEXT id = "fname" '
                                        . 'name = "fname"></td>';
                                    }
                                    ?>
                                </tr>
                                <tr>
                                    <td class="right"><label for="lname">
                                            Last&nbsp;name:</label></td>
                                    <?php
                                    if (!$result) {
                                        ...
                                        echo '<td><input type = TEXT id = "lname" '
                                        . 'name = "lname"></td>';
                                    }
                                    ?>
                                </tr>
                                <tr>
                                    ...
                                    if (!$result) {
                                        if (empty($email)) {
                                            echo '<td><input type = "email"
                                                id = "email" name = "email"
                                                size="30"
                                                placeholder="john.doe@domainname
                                                .com"><span class="error"> *
                                                Required</span></td>';
                                        } else {
                                            echo "<td><input type = \"email\" "
                                            . "id = \"email\" name = \"email\" "
                                ...
                                if ((!empty($firstname[TEXT]) 
                                    ...
                                    echo '<tr><td class="right error"><label><b>'
                                    . '*&nbsp;Invalid&nbsp;text:</b></label></td>';
                                    echo "<td>Text must begin and end with an "
                                    . "alphbetical character (a,A,b,B,c,C,...),"
                                    . " and must only contain alphbetic characters "
                                    . "and"
                                    . " zero or more single spaces, zero or more "
                                    . "single apostrophies, "
                                    . "and zero or more single hyphens.  Spaces, "
                                    . "apostrophies and hyphens"
                                    . " can only be used individually<br/>(e.g. "
                                    . "\"James the third\""
